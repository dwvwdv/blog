...
export const Juejin = () => (
  ...
  >
    ...
    // </svg>
		...
		<img src="https://hitcon.org/2024/CMT/img/HAT-HITCON.svg" style="width:1em;height:1em;"></img>
    <ExternalLink title='HITCON' href='https://zeroday.hitcon.org/user/dwvwdv/vulnerability' />
  </Block>
)
